...
* **codex-local:** select generic transports with per-step tool bindings ([#193](https://github.com/Canner/Warble/issues/193))
...
* **codex-local:** execute isolated component invocation ([#194](https://github.com/Canner/Warble/issues/194)) ([406b16e](https://github.com/Canner/Warble/commit/406b16eabd13b4758e177f041e2b485bfcd1ee91))
* **codex-local:** select generic transports with per-step tool bindings ([#193](https://github.com/Canner/Warble/issues/193)) ([124348a](https://github.com/Canner/Warble/commit/124348aa59c0399618d946e6576665d6105d938c))
* **codex-local:** verify bound context preconditions ([#195](https://github.com/Canner/Warble/issues/195)) ([913377b](https://github.com/Canner/Warble/commit/913377b64f4fe64019bf43502624a093b31cbe81))
...
* **core:** name the host's analysis `impact`, not `blast_radius` ([#175](https://github.com/Canner/Warble/issues/175))

### Features

* **agent-sdk:** let an embedder compose enforcement instead of replacing it ([#171](https://github.com/Canner/Warble/issues/171)) ([be9385e](https://github.com/Canner/Warble/commit/be9385eae9ee4a6b1747aa0b7f111a33308f7a0c))
...
* **core:** carry the host's own analysis in a prepared context document ([#173](https://github.com/Canner/Warble/issues/173)) ([a821c2c](https://github.com/Canner/Warble/commit/a821c2c5e9ebc350e44dd0b161d43779eb7192d6))
* fingerprint the prompts a dispatch sent, since the IR hash no longer can ([#176](https://github.com/Canner/Warble/issues/176)) ([7836f83](https://github.com/Canner/Warble/commit/7836f83744864cb2614f557d4c9c5bc20774c931))
* resolve prompt slots at dispatch instead of shipping the placeholder ([#174](https://github.com/Canner/Warble/issues/174)) ([57301f4](https://github.com/Canner/Warble/commit/57301f4fc370f303b563268dd2afa6162286ce6b))
...
* **core:** name the host's analysis `impact`, not `blast_radius` ([#175](https://github.com/Canner/Warble/issues/175)) ([d6f1b10](https://github.com/Canner/Warble/commit/d6f1b101f23f543aa736bba561a8431a4f50b580))
...
* **core:** let a profile author one system prompt for every component ([#157](https://github.com/Canner/Warble/issues/157)) ([fea5ca0](https://github.com/Canner/Warble/commit/fea5ca0b0d770e4e5576cd4af1f9f8abee53554a))
* **eval:** add attestation_gate, a declarable fresh-verdict gate ([#159](https://github.com/Canner/Warble/issues/159)) ([c9c215b](https://github.com/Canner/Warble/commit/c9c215baaa8d4a079b6add4134de6745ae6d4acc))


### Bug Fixes

* **release:** verify the npm-downloaded binary against its published checksum ([#160](https://github.com/Canner/Warble/issues/160)) ([08ce11f](https://github.com/Canner/Warble/commit/08ce11fd2e27f61281f0915be4cf21dce5618a1b))
