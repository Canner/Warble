...
<CardGroup cols={2}>
  <Card title="Tiers & model binding" icon="layer-group" href="/concepts/tiers-and-model-binding">
    How an authored tier becomes a concrete model at dispatch time.
  </Card>
  <Card title="Capabilities & guardrails" icon="shield-halved" href="/concepts/capabilities-and-guardrails">
    What a component asks of its runtime, and what it can never be talked out of.
  </Card>
</CardGroup>
