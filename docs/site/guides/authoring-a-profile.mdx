...
<Steps>
<Step title="Lay out the project">
...
<Step title="Write profile.yml and mount components">
...
<Step title="Apply config and per-component overrides">
...
<CardGroup cols={2}>
  <Card title="Profiles" icon="file-code" href="/concepts/profiles">
    The Harness + Context mental model this page builds on.
  </Card>
  <Card title="Profile schema" icon="brackets-curly" href="/reference/profile-schema">
    Every profile and mount-entry field, exhaustively.
  </Card>
</CardGroup>
