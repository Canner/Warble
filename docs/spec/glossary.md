...
| **Back-end / dispatcher** | Legalizes the IR onto one runtime and emits a native agent. Thin and swappable; Warble ships three reference back-ends (a Claude Code file target, a serverless-bundle target, and a Claude Agent SDK in-loop target). |
