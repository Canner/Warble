# Provider fragments — the dispatch-time capability binding (`fragment_version: 0.1`)
...
[`binding-spec.md`](./binding-spec.md) describes for the tier→model binding, and it needs the same
