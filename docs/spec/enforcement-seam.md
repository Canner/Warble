# Enforcement seam — guardrails as runtime enforcement, not just IR data
...
target capability profile supplies criticality (see [`capability-model.md`](./capability-model.md)). This document
...
`blast_radius` (see [`blast-radius.md`](./blast-radius.md) §6–§7): the lineage-derived severity and
...
[`component-composition.md`](./component-composition.md) for the complete specified contract and
